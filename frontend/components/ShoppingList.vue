<template>
  <section class="section pt-0 mb-4 has-background-light">
    <div class="columns is-xmobile header pt-2">
      ...
      <div class="column is-2 is-hidden-mobile has-text-centered">Req.</div>
    </div>
    <div
    ...
    >
      <div class="is-hidden-tablet" style="border: 0.5px dotted black"></div>
      <div class="column">
        <div class="icon grow" @click="p.inCart = !p.inCart" name="check">
      ...
      <div class="column is-4">
        <div class="icon is-large grow" name="decrease_bought" @click="p.bought = Math.max(0, p.bought-1)">
          <i class="fas fa-minus fa-lg"></i>
        </div>
        <input class="is-size-5" type="number" min="0" v-model="p.bought" name="number_bought" />
        <div class="icon is-large grow" name="increase_bought" @click="p.bought +=1">
